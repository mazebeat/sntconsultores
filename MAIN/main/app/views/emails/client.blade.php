...
<head>
	...
	<style type="text/css">
		...
		.one-col-feature h1, .one-col-feature h2, .one-col-feature h3 {
			text-align: center
		}
		...
		.one-col-feature blockquote:before, .one-col-feature blockquote:after {
			background: -moz-linear-gradient(left, #fff 25%, #e9e9e9 25%, #e9e9e9 75%, #fff 75%);
			...
			background: -webkit-linear-gradient(left, #fff 25%, #e9e9e9 25%, #e9e9e9 75%, #fff 75%);
			background: -o-linear-gradient(left, #fff 25%, #e9e9e9 25%, #e9e9e9 75%, #fff 75%);
			background: -ms-linear-gradient(left, #fff 25%, #e9e9e9 25%, #e9e9e9 75%, #fff 75%);
			background: linear-gradient(to right, #fff 25%, #e9e9e9 25%, #e9e9e9 75%, #fff 75%);
			content: '';
			display: block;
			height: 2px;
			left: 0;
		...
		<tr>
			<td style="padding: 0;vertical-align: top">
				<table style="border-collapse: collapse;border-spacing: 0;width: 602px">
					<tbody>
					<tr>
						<td class="title" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: left;color: #999;font-family: sans-serif">{{ Config::get('api.company.contactemail') }}</td>
					</tr>
					</tbody>
				</table>
			</td>
					...
					<tr>
						<td class="column" style="padding: 0;vertical-align: top;text-align: center;width: 600px">
							...
							<table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
								...
								<tr>
									<td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
										<p style="Margin-top: 0;color: #565656;font-family: Tahoma,sans-serif;font-size: 21px;line-height: 30px;Margin-bottom: 32px;text-align: left">Estimado(a) {{ $name }},</p>

										<p style="Margin-top: 0;color: #565656;font-family: Tahoma,sans-serif;font-size: 20px;line-height: 30px;Margin-bottom: 32px;text-align: left">Muy pronto un integrante de nuestro seleccionado equipo se contactar&#225; con usted.</p>

										<p style="Margin-top: 0;color: #565656;font-family: Tahoma,sans-serif;font-size: 21px;line-height: 30px;Margin-bottom: 32px;text-align: right">SNT Consultores.</p>
									</td>
								</tr>
								</tbody>
							</table>
