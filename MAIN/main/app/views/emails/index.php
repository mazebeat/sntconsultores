...
<head>
	<title>SNT Consultores - Contacto</title>
...
<body style="margin: 0;mso-line-height-rule: exactly;padding: 0;min-width: 100%;background-color: #dbdbdb">
<style type="text/css">
	...
	.wrapper
	.one-col-feature p, .wrapper .one-col-feature ol, .wrapper .one-col-feature ul {
		line-height: 30px
	}
	...
	.preheader .title
	a, .preheader .webversion a, .footer .padded a {
		color: #999
	}
...
<center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #dbdbdb">
		...
		<tr>
			<td style="padding: 0;vertical-align: top">
				<table style="border-collapse: collapse;border-spacing: 0;width: 602px">
					<tbody>
					<tr>
						<td class="title" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: left;color: #999;font-family: sans-serif">contacto@snt-consultores.net</td>
						<td class="webversion" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: right;width: 300px;color: #999;font-family: sans-serif">
							&#191;No aparecen im&#225;genes?
							<webversion style="font-weight:bold;text-decoration:none;">Versi&#243;n web</webversion>
						</td>
					</tr>
					</tbody>
				</table>
	...
	<table class="header centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 602px">
		<tbody>
		<tr>
			<td class="border" style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #ccc;width: 1px">&nbsp;</td>
		</tr>
		<tr>
			<td class="logo" style="padding: 16px 0;vertical-align: top;mso-line-height-rule: at-least">
				<div class="logo-center" style="font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e;font-family: sans-serif;text-align: center" align="center" id="emb-email-header">
					<a style="text-decoration: none;transition: all .2s;color: #41637e" href="{{ URL::to(Config::get('api.company.web')) }}"><img style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 320px" src="{{ $message->embed(public_path('images/emails/logo.png')) }}" alt="SNT Consultores" width="240" height="120"/></a>
				</div>
			</td>
		</tr>
		</tbody>
	...
	<table class="border" style="border-collapse: collapse;border-spacing: 0;font-size: 1px;line-height: 1px;background-color: #ccc;Margin-left: auto;Margin-right: auto" width="602">
		<tbody>
		<tr>
					...
					<tr>
						<td class="column" style="padding: 0;vertical-align: top;text-align: center;width: 600px">
							...
							<table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
								...
								<tr>
									<td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
										<h3 style="Margin-top: 0;color: #555;font-weight: normal;font-size: 32px;line-height: 40px;Margin-bottom: 20px;font-family: sans-serif;font-style: italic;text-align: center">Gracias por contactarnos!</h3>
									</td>
								</tr>
								</tbody>
							</table>
							...
							<table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
								...
								<tr>
									<td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
										<p style="Margin-top: 0;color: #565656;font-family: Tahoma,sans-serif;font-size: 21px;line-height: 30px;Margin-bottom: 32px;text-align: left">Estimado(a) {{ Str::upper($name) }},</p>

										<p style="Margin-top: 0;color: #565656;font-family: Tahoma,sans-serif;font-size: 21px;line-height: 30px;Margin-bottom: 32px;text-align: left">Muy pronto un integrante de nuestro seleccionado equipo se contactar&#225; con usted.</p>
									</td>
								</tr>
								</tbody>
							</table>
	...
	<table class="footer centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 602px">
		<tbody>
<!--		<tr>-->
<!--			<td class="social" style="padding: 0;vertical-align: top;padding-top: 32px;padding-bottom: 22px" align="center"></td>-->
<!--		</tr>-->
		<tr>
			<td class="border" style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #ccc;width: 1px">&nbsp;</td>
		</tr>
		<tr>
			<td style="padding: 0;vertical-align: top">
				<table style="border-collapse: collapse;border-spacing: 0">
					<tbody>
					<tr>
						<td class="address" style="padding: 0;vertical-align: top;width: 300px;padding-top: 32px;padding-bottom: 64px">
							<table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
								<tbody>
								<tr>
									<td class="padded" style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;word-break: break-word;word-wrap: break-word;text-align: left;font-size: 12px;line-height: 20px;color: #999;font-family: sans-serif">
										<div>{{ Config::get('api.company.name') }} {{ Carbon::now()->year  }}</div>
									</td>
								</tr>
								</tbody>
							</table>
...
<!--								<tbody>-->
<!--								<tr>-->
<!--									<td class="padded" style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;word-break: break-word;word-wrap: break-word;font-size: 12px;line-height: 20px;color: #999;font-family: sans-serif;text-align: right">-->
<!--										<div>-->
<!--											<span class="block"></span> <span class="block"><unsubscribe style="font-weight:bold;text-decoration:none;">Desuscribirse</unsubscribe></span>-->
<!--										</div>-->
<!--									</td>-->
<!--								</tr>-->
<!--								</tbody>-->
