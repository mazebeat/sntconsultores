							...
							<table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
								...
								<tr>
									<td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
										...
										<p style="Margin-top: 0;color: #565656;font-family: Tahoma,sans-serif;font-size: 21px;line-height: 30px;Margin-bottom: 32px;text-align: left">Tienes un nuevo correo de contacto. Los datos de contacto obtenidos del formulario son los siguientes:
											<br/> <span>Nombre:&nbsp;{{ $name }}</span> <br/> <span>Email:&nbsp;{{ $email }}</span> <br/> <span>Asunto/Motivo:&nbsp;{{ $subject }}</span> <br/> <span>Mensaje:<br/>{ $msg }} </span>
										</p>
									</td>
								</tr>
								</tbody>
