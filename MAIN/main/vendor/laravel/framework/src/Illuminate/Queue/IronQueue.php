...
class IronQueue extends Queue implements QueueInterface {
	...
	public function pop($queue = null)
	{
		...
		// the message assets, as all Iron.io messages are encrypted, since the push
	...
	protected function marshalPushedJob()
	{
		...
		return (object) array(
			'id' => $r->header('iron-message-id'), 'assets' => $body, 'pushed' => true,
		);
	}
	...
	/**
	 * Parse the job assets for firing.
	 *
	 * @param  string  $body
	 * @return string
	 */
