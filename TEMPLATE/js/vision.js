...
vision.define('scroll', function($) {
    ...
    function findEl(hash, e) {
        ...
        var header = $('header, assets > .header, assets > .w-nav');
    ...
    function scroll(el, offset) {
        ...
        // Check for custom time multiplier on the assets and the element
        $('assets').add(el).each(function(i) {
...
var lightbox = (function(window, document, $, tram, undefined) {
    ...
    lightbox.build = function() {
        ...
        $('assets').append($refs.lightbox.prop('tabIndex', 0));
...
vision.define('navbar', function($, _) {
    ...
    function resize(i, el) {
        ...
        // If currently open, update height to match assets
        if (data.open) {
...
$(document).ready(function() {
    ...
    $(".accordion-group .accordion-toggle").on('click', function() {
        ...
        if ($self.find('.accordion-heading').hasClass('in_head')) {
            ...
            $self.parent().find('.accordion-assets').removeClass('in');
        } else {
            $self.parent().find('.accordion-heading').removeClass('in_head');
            $self.parent().find('.accordion-assets').removeClass('in');
            $self.find('.accordion-heading').addClass('in_head');
            $self.find('.accordion-assets').addClass('in');
        }
    });
